    ...
    <button class='btn btn-success' type="submit" name="search" id="searchbtn">Search</button>
            ...
            <table class="table">
                ...
                <thead class="bg-primary">
                    ...
                    <tr class="text-white">
                                ...
                                <th scope="col">Request Time  <?php echo "<a class='text-white' href='history.php?sort=ASC&colunm=request_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='history.php?sort=DESC&colunm=request_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?> </th>

                                <th scope="col">Assigned Time  <?php echo "<a class='text-white' href='history.php?sort=ASC&colunm=assigned_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='history.php?sort=DESC&colunm=assigned_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?>   </th>

                                <th scope="col">Return Time <?php echo "<a class='text-white' href='history.php?sort=ASC&colunm=return_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='history.php?sort=DESC&colunm=return_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?> </th>

                                <th scope="col">Reject Time  <?php echo "<a class='text-white' href='history.php?sort=ASC&colunm=reject_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='history.php?sort=DESC&colunm=reject_time&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?>   </th>
        ...
        
        {
          ...
          if ($i==$pn) {
              ...
              $pagLink .= "<li class='page-item bg-dark'><a class='page-link bg-primary' style='color:white;' href='history.php?page=".$i."&colunm=".$colunm."&sort=".$sort."&searchdata=".$valueToSearch."'>".$i."</a></li>";

              $_SESSION['pagevalue']=$i;
          }            
          else  {

              $pagLink .= "<li class='page-item'><a class='page-link' href='history.php?page=".$i."&colunm=".$colunm."&sort=".$sort."&searchdata=".$valueToSearch."'> ".$i."</a></li>";  
       ...
       if($x > 1){
        ...
        echo "<li class='page-item'><a class='page-link' href='history.php?page=".($x-1)."&colunm=".$colunm."&sort=".$sort."&searchdata=".$valueToSearch."'><<</a></li>";
