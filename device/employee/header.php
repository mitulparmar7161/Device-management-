  ...
  <div class="offcanvas-body">
    ...
    <nav class="navbar navbar-expand-md bg-primary navbar-dark ">
        ...
        <div class="container-fluid d-flex justify-content-spacebetween">
            ...
            <button class="btn text-white" type="button" id="toggle-button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><h4>Menu</h4></button>
