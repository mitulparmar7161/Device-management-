...
<body>
    ...
    <button class='btn btn-success' type="submit" name="search" id="searchbtn">Search</button>
            ...
            <table class="table">
                ...
                <thead class="bg-primary">
                    ...
                    <tr class="text-white">
                                ...
                                <th scope="col">Device Name    <?php echo "<a class='text-white' href='home.php?sort=ASC&colunm=device_name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='home.php?sort=DESC&colunm=device_name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?> </th>
...

        {
            ...
            $sql = "SELECT COUNT(*) FROM device WHERE status='available' and CONCAT(`type`,`device_name`,`status`) LIKE '%".$valueToSearch."%'";
