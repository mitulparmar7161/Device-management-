 ...
 <option  value="">All users</option>
    ...
    <button class='btn btn-success' type="submit" name="search" id="searchbtn">Search</button>
...

        {
            ...
            $sql = "SELECT COUNT(*) from device_record  inner join device on device.id=device_record.device_id  inner join user on user.id=device_record.emp_id WHERE name LIKE '%".$search_name."%' and CONCAT(`device_name`,`name`,`request_time`, `assigned_time`, `return_time`,`reject_time`) LIKE '%".$valueToSearch."%'";
