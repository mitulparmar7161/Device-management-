            ...
            <table class="table">
                ...
                <thead class="bg-primary">
                    ...
                    <tr class="text-white">
                                ...
                                <th scope="col">Device   <?php echo "<a class='text-white' href='device_record.php?sort=ASC&colunm=device_name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='device_record.php?sort=DESC&colunm=device_name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?> </th>

                                <th scope="col">Employee  <?php echo "<a class='text-white' href='device_record.php?sort=ASC&colunm=name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▲</a> <a class='text-white' href='device_record.php?sort=DESC&colunm=name&searchdata=".$_SESSION['search_string']."&page=".$pn."'>▼</a>";  ?></th>
